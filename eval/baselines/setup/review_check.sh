#!/usr/bin/env bash
#SBATCH --job-name=review-check
#SBATCH --nodes=1 --ntasks=1
#SBATCH --time=01:30:00
#SBATCH --output=/home/fzheng4/AccelProf/eval/baselines/setup/build_logs/review-check-%j.log
# T1a review (eval/CP_ASYNC_REPORT.md §6), same checks as t1a_check.sh for the review
# worktree: (1) the default tool path and the vector-clock dumps of two
...
#   PIN8G=1 sbatch -p rtx4060ti8g -w c20 eval/baselines/setup/review_check.sh
set -u
W=${W:-/home/fzheng4/wt-T1a-review}; A=/home/fzheng4/AccelProf
cd $W || exit 1
...
OUT=/mnt/beegfs/$USER/review_check; rm -rf $OUT; mkdir -p $OUT
run() {
...
echo "== (3) green set (this worktree's runtime) + test_cp_async.py"
